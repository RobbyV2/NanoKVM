...
| D5 | Migration preserves whatever the sentinels say, including the NCM-wins-over-RNDIS precedence at `S03usbdev:53,61`. NCM is never imposed on an RNDIS user. Choosing between them becomes an explicit profile choice in Program 3. |
