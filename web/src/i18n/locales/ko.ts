  ...
  translation: {
    ...
    devices: {
      ...
      permission: {
        ...
        insecure:
          '이 페이지가 HTTPS로 제공되지 않아 브라우저가 이 장치를 차단합니다. 설정 - 네트워크에서 HTTPS를 활성화하세요.'
      },
      capture: {
    ...
    settings: {
      ...
      display: {
        ...
        active: '현재 EDID',
        activeUnknown:
          'NanoKVM이 부팅 이후 EDID를 기록한 적이 없어 호스트가 인식하는 모니터 정보를 알 수 없습니다.',
        appliedAt: '적용 시각 {{time}}',
        download: '다운로드',
        downloadBackup: '이전 항목 다운로드',
        preset: '모니터 프리셋',
        presetPlaceholder: '모니터 선택',
        upload: '업로드',
        selected: '선택한 EDID',
        errors: '오류',
        warnings: '경고',
        ...
        audioYes: '오디오 지원',
        audioNo: '오디오 없음',
        extensionBlocks: '확장 블록: {{blocks}}',
        apply: '적용',
        applyTitle: '이 EDID를 적용할까요?',
        before: '현재',
        after: '변경 후',
        hdmiNotice:
        ...
        unsupported: '이 장치는 EDID 변경을 지원하지 않습니다.',
        toolMissing: '이 펌웨어에 EDID 도구가 없습니다.',
        noAudio: '이 EDID는 오디오를 알리지 않으므로 호스트가 소리 전송을 중단할 수 있습니다.',
        oldVersion: '이 EDID는 1.4보다 낮은 버전을 사용합니다.',
        interlaced: '기본 타이밍이 인터레이스 방식입니다.',
        tooLarge: '기본 타이밍이 1920x1080 60Hz보다 커서 NanoKVM이 캡처할 수 있는 범위를 넘습니다.',
        recovery: '복구',
        recoveryNeeded:
          '마지막 쓰기가 검증되지 않아 영상 칩의 EDID 영역이 알 수 없는 상태입니다. 공장 EDID를 복원하여 상태를 다시 확인할 수 있게 만드세요.',
        recoveryDesc:
          '적용한 EDID 때문에 호스트에 화면이 나오지 않을 때, 알려진 EDID를 영상 칩에 다시 씁니다.',
        restoreFactory: '공장 EDID 복원',
        restoreBackup: '이전 EDID 복원',
        restoreTitle: '이 EDID를 복원할까요?',
        restoreFactoryTarget: 'NanoKVM에 기본 제공되는 공장 EDID입니다.',
        restoreBackupTarget: '가장 최근 백업이며 {{time}}에 적용되었습니다.',
      ...
      update: {
        ...
        rebooting:
          '새 커널을 설치하고 재부팅하는 중입니다. 몇 분 정도 걸릴 수 있으니 전원을 끄지 마세요.',
        kernelUpdate:
          '이 업데이트는 커널 {{version}}을(를) 설치합니다. 장치가 재부팅되며, 새 커널이 시작되지 않으면 현재 커널로 자동 복구됩니다.',
        rolledBack: '커널 {{version}}이(가) 시작되지 않아 장치가 이전 커널로 되돌아갔습니다.',
