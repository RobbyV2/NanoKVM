const uk = {
  translation: {
    ...
    devices: {
      ...
      empty:
        'Слоти камери, мікрофона або динаміка не налаштовані. Додайте їх у розділі «Налаштування — Пристрій».',
      available: 'Доступно',
      waiting: 'Хост чекає на джерело',
      hostOpen: 'Хост відкрив потік',
      hostIdle: 'Хост не активний',
      hostPlaying: 'Хост відтворює звук',
      hostSending: 'Хост відтворює',
      sending: 'Передавання з цього браузера',
      receiving: 'Відтворення в цьому браузері',
      black: 'Чорне відео',
      ...
      permission: {
        ...
        insecure:
          'Сторінку відкрито не через HTTPS, тому браузер блокує цей пристрій. Увімкніть HTTPS у розділі «Налаштування — Мережа».'
      },
      capture: {
        unsupported: 'Цей браузер не може записувати звук і відео',
        camera: 'Цей браузер не може кодувати кадри камери',
        microphone: 'Цей браузер не може обробляти звук мікрофона',
        speaker: 'Цей браузер не може відтворювати звук'
      },
      mic: {
      ...
      usb: {
        ...
        unsupported: 'Для WebUSB потрібен браузер на Chromium',
        insecure:
          'Сторінку відкрито не через HTTPS, тому браузер приховує WebUSB. Увімкніть HTTPS у розділі «Налаштування — Мережа».',
    ...
    settings: {
      ...
      passthrough: {
        ...
        copyInsecure:
          'Сторінку відкрито не через HTTPS, тому браузер заборонив копіювання. Скопіюйте команду вручну або увімкніть HTTPS у розділі «Налаштування — Мережа».',
        directNote:
      ...
      mcp: {
        ...
        copyInsecure:
          'Сторінку відкрито не через HTTPS, тому браузер заборонив копіювання. Скопіюйте вручну або увімкніть HTTPS у розділі «Налаштування — Мережа».',
        okBtn: 'Підтвердити',
        cancelBtn: 'Скасувати'
      },
      about: {
      ...
      appearance: {
        ...
        faviconDesc: 'Налаштуйте значок вкладки браузера',
        faviconPlaceholder: 'URL зображення',
        faviconUpload: 'Завантажити',
        faviconReset: 'Скинути',
        faviconCustom: 'Власний значок',
        faviconBoot: 'Значок із /boot/logo.ico',
        faviconDefault: 'Типовий значок',
        faviconOverridesBoot: 'Замінює /boot/logo.ico',
        faviconErrUrl: 'Введіть адресу зображення http:// або https://',
        faviconErrFetch: 'Пристрою не вдалося завантажити це зображення',
        faviconErrLarge: 'Зображення завелике. Обмеження — 256 КБ',
        faviconErrType: 'Непідтримуване зображення. Використайте .ico, .png, .svg, .gif або .jpg',
        faviconErrSave: 'Не вдалося зберегти значок',
        menuBar: {
          title: 'Рядок меню',
      ...
      device: {
        ...
        rebindNotice:
          'Перемикання цього тумблера заново перелічує USB-пристрій, тож цільовий хост ненадовго втрачає віртуальні пристрої та USB-мережу.',
        media: {
          title: 'Слоти камери, мікрофона та динаміка',
          desc: 'Укажіть мультимедійні пристрої, які бачить цільовий комп’ютер. Бюджет кінцевих точок перевіряється під час застосування профілю USB. Збереження знову перелічує пристрій і від’єднує підключені браузери.',
          cameras: 'Камери',
          ...
          limit: 'Слотів камери, мікрофона та динаміка разом має бути не більше восьми.',
      ...
      network: {
        ...
        usb: {
          title: 'Мережевий адаптер через USB',
          desc: 'Дає керованому комп’ютеру мережеву карту через USB',
          type: 'Тип адаптера',
          typeDesc: 'NCM для сучасних систем, RNDIS для старих Windows'
        },
        bridge: {
          title: 'Адаптер під’єднано до',
          lan: 'Ваша мережа',
          kvmOnly: 'Лише NanoKVM',
          lanDesc:
            'Комп’ютер потрапляє у вашу мережу через Ethernet-порт NanoKVM і отримує власну адресу від маршрутизатора.',
          kvmOnlyDesc: 'Комп’ютер отримує адресу від NanoKVM і дістає до NanoKVM, але не далі.',
          loading: 'Завантаження...',
          state: 'Стан',
          states: {
            disabled: 'Лише NanoKVM',
            enabled: 'Ваша мережа',
          ...
          down: 'неактивний',
          noLink: 'немає лінка',
          enableTitle: 'Під’єднати комп’ютер до вашої мережі?',
          disableTitle: 'Обмежити комп’ютер лише NanoKVM?',
          reconnect:
          ...
          enableBtn: 'Під’єднати до моєї мережі',
          disableBtn: 'Лише NanoKVM',
          cancelBtn: 'Скасувати',
          interrupted:
      ...
      exit: {
        title: 'Вихідний тунель',
        description:
          'Перетворює мережевий інтерфейс USB на вихід в інтернет для цільового комп’ютера: його трафік виходить через ваш пристрій, який підключається за цією веб-адресою.',
        loading: 'Завантаження...',
        noSlots: 'На цьому пристрої не налаштовано жодного вихідного слота.',
        slot: 'Слот {{slot}}',
        enable: 'Вихідний тунель',
        pending: 'застосовується...',
        statusStale: 'стан не оновлюється',
        enableConfirm: 'Увімкнути вихідний тунель?',
        disableConfirm: 'Вимкнути вихідний тунель?',
        reenumerate:
          'USB-гаджет перепідключається, щоб цільовий комп’ютер отримав новий шлюз і DNS. Клавіатура, миша, камера та віртуальний диск зникають приблизно на дві секунди.',
        okBtn: 'Так',
        cancelBtn: 'Ні',
        copy: 'Копіювати',
        copied: 'Скопійовано',
        ...
        status: {
          title: 'Стан',
          disconnect: 'Відключити вихід',
          disconnectDesc:
            'Розриває з’єднання з підключеним вихідним пристроєм. Його клієнт перепідключиться сам, якщо ви не зупините його заздалегідь.',
          tunnel: 'Тунель',
          uptime: 'працює {{uptime}}',
          lastConnected: 'останнє підключення {{time}}',
          never: 'ніколи',
          peer: 'Вихідний пристрій',
          noPeer: 'Вихідний пристрій не підключено',
          peerChanged: 'Замінив {{addr}} о {{time}}',
          nic: 'Мережевий адаптер цілі',
          nicUp: 'активний',
          nicDown: 'неактивний',
          nicMissing: 'Ще не визначено',
          nicNone:
            'Поточний USB-профіль не містить мережевої функції. Увімкніть мережевий адаптер через USB у розділі «Мережа», щоб цільовий комп’ютер отримав мережевий адаптер.',
          upstream: 'Інтернет',
          reachable: 'Доступний',
          unreachable: 'Недоступний',
          latency: '{{ms}} мс',
          notProbed: 'Не перевіряється, поки не підключено вихід',
          downstream: 'Низхідний шлях',
          downstreamOff: 'Вимкнено, поки тунель відключено',
          downstreamDegraded:
            'Частина низхідного шляху відсутня. Сторожовий таймер повторює спробу кожні 30 секунд; журнали нижче показують, що не вдалося.',
          downstreamTip: {
            forward: 'Пересилання IPv4 увімкнено',
          ...
          dns: 'DNS',
          dnsStats: '{{queries}} запитів, {{failures}} невдалих, {{redirected}} перенаправлено',
          traffic: 'Трафік',
          trafficUp: '{{bytes}} до виходу',
          trafficDown: '{{bytes}} від виходу'
        },
        token: {
          title: 'Токен',
          history:
            'Входить до кожної команди нижче, тому потрапляє в історію оболонки вихідного пристрою.',
          regenerate: 'Перевипустити',
          regenerateConfirm: 'Перевипустити токен?',
          regenerateDesc:
            'Спочатку зупиніть запущений клієнт. Усі підключені виходи буде відключено, а старі команди перестануть працювати.'
        },
        mode: {
          title: 'Режим',
          native: 'Рідний',
          wstunnel: 'wstunnel',
          nativeDesc:
            'На вихідному пристрої працює невеликий скрипт, завантажений із цього NanoKVM. Нічого встановлювати не потрібно.',
          wstunnelDesc:
            'Вихідний пристрій завантажує закріплений бінарний файл {{version}} і перевіряє його SHA-256 перед запуском.',
          whileEnabled:
            'Зміна режиму при ввімкненому тунелі відключає підключений вихідний пристрій; запустіть його знову командою нового режиму.'
        },
        commands: {
          title: 'Виконайте на вихідному пристрої',
          description:
            'Вставте одну команду на комп’ютері, чий інтернет має використовувати ціль. Вона перепідключатиметься, доки ви її не зупините.',
          warnDownload:
            'Команда завантажує скрипт із цього NanoKVM і запускає його від імені вашого користувача.',
          warnSecret:
          ...
          security:
            'Цільовий комп’ютер уже має доступ до веб-інтерфейсу, SSH і VNC цього NanoKVM за адресою USB-мережі. Ця функція цього не змінює.',
          latestTitle: 'Останній wstunnel',
          latestDesc:
            'Під час запуску команди визначає найновіший випуск wstunnel на GitHub і звіряє завантаження з checksums.txt цього випуску, тож це не закріплена версія {{version}} і закріпленого хешу в ній немає. Лише Windows і Linux.',
          latestFallback:
            'Якщо завантаження не вдалося, завантажте його з github.com/erebe/wstunnel',
          latestUnavailable:
            'Для macOS команди отримання останньої версії немає. Скористайтеся закріпленою командою вище або посиланням на репозиторій.'
        },
        advanced: {
          title: 'Додатково',
          dns: 'DNS-сервери',
          dnsTip:
            'До чотирьох резолверів, доступних через вихід. Цільовий комп’ютер отримує NanoKVM як резолвер, і кожен відкритий DNS-запит перенаправляється сюди.',
          dnsAdd: 'Додати сервер',
          dnsRemove: 'Видалити сервер',
          dnsInvalid: 'Вводьте лише IP-адреси',
          dnsDenied: 'Адреси loopback, link-local, multicast і 198.18/15 недосяжні через вихід',
          dnsPrivate: 'Для приватного резолвера потрібно увімкнути Дозволити приватні призначення',
          mtu: 'MTU',
          mtuTip: 'Від {{min}} до {{max}}. 1280 залишає місце для заголовків тунелю.',
          allowPrivate: 'Дозволити приватні адреси призначення',
          allowPrivateTip:
            'Дозволяє цільовому комп’ютеру досягати власної локальної мережі вихідного пристрою: 10/8, 172.16/12, 192.168/16, 100.64/10 і fc00::/7. Вимкнено — вони відхиляються.',
          pinPeer: 'Закріпити за першим виходом',
          pinPeerTip:
            'Відхиляє підключення з іншої адреси, доки не буде вимкнено. Інакше нове дійсне підключення замінює старе.',
          save: 'Зберегти',
          saved: 'Збережено'
        },
        logs: {
          title: 'Журнал',
          empty: 'Записів у журналі поки немає',
          refresh: 'Оновити',
      ...
      update: {
        ...
        offline: {
          kernelNotice:
            'Пакет містить ядро. Його записують у резервний слот, і пристрій перезавантажується для пробного запуску; якщо він не підніметься, пристрій сам повернеться до поточного ядра.',
          kernelConfirm: 'Встановити ядро',
          kernelCancel: 'Скасувати',
    ...
    error: {
      ...
      refresh: 'Оновити',
      panel: 'Ця панель перестала працювати',
