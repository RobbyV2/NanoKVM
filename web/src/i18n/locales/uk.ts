  ...
  translation: {
    ...
    settings: {
      ...
      device: {
        ...
        rebindNotice:
          'Перемикання будь-якого з тумблерів заново перелічує USB-пристрій, тож цільовий хост ненадовго втрачає віртуальні пристрої та USB-мережу.',
        media: {
          ...
          budgetHint:
            'Шість кінцевих точок USB IN — жорстке обмеження апаратури. Зберіть клавіатуру, мишу та абсолютний вказівник на одному HID-інтерфейсі в розділі «Подання USB» або вимкніть вище віртуальний диск чи USB-мережу.',
          unsupported:
