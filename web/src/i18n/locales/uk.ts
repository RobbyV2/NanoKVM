  ...
  translation: {
    ...
    settings: {
      ...
      passthrough: {
        ...
        isoWarning: 'Вебкамери, мікрофони та інші ізохронні пристрої пробросити неможливо',
        isoWarningDesc:
          'Це обладнання підтримує лише керувальні, об’ємні та переривальні передачі. Аудіо- та відеопристрої не працюватимуть, хоч як їх прив’язуй.',
        session: 'Сеанс',
        ...
        startedAt: 'Запущено',
        isoDevice:
          'Цей пристрій повідомляє клас аудіо або відео, якому потрібні ізохронні передачі. Він не працюватиме.',
        ...
        startIso:
          'Вебкамери, мікрофони та інші ізохронні пристрої на цьому обладнанні не працюватимуть.',
        startWeb:
