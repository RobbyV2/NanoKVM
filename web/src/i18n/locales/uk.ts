    ...
    settings: {
      ...
      exit: {
        ...
        commands: {
          ...
          latestDesc:
            'Під час запуску команди визначає найновіший випуск wstunnel на GitHub і звіряє завантаження з checksums.txt цього випуску, тож це не закріплена версія {{version}} і закріпленого хешу в ній немає.',
          latestFallback:
