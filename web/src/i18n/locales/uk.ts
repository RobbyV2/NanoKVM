const uk = {
  translation: {
    ...
    devices: {
      ...
      empty: 'Слоти камери або мікрофона не налаштовані. Додайте їх у розділі «Налаштування — Пристрій».',
      available: 'Доступно',
      ...
      usb: {
        ...
        insecure: 'Сторінку відкрито не через HTTPS, тому браузер приховує WebUSB. Увімкніть HTTPS у розділі «Налаштування — Мережа».',
    ...
    settings: {
      ...
      passthrough: {
        ...
        copyInsecure: 'Сторінку відкрито не через HTTPS, тому браузер заборонив копіювання. Скопіюйте команду вручну або увімкніть HTTPS у розділі «Налаштування — Мережа».',
        directNote:
      ...
      mcp: {
        ...
        copyInsecure: 'Сторінку відкрито не через HTTPS, тому браузер заборонив копіювання. Скопіюйте вручну або увімкніть HTTPS у розділі «Налаштування — Мережа».',
        okBtn: 'Підтвердити',
        cancelBtn: 'Скасувати'
      },
      about: {
      ...
      device: {
        ...
        rebindNotice: 'Перемикання будь-якого з тумблерів заново перелічує USB-пристрій, тож цільовий хост ненадовго втрачає віртуальні пристрої та USB-мережу.',
        media: {
          ...
          budgetHint: 'Шість кінцевих точок USB IN — жорстке обмеження апаратури. Зберіть клавіатуру, мишу та абсолютний вказівник на одному HID-інтерфейсі в розділі «Подання USB» або вимкніть вище віртуальний диск чи USB-мережу.',
          unsupported:
      ...
      update: {
        ...
        offline: {
          kernelNotice: 'Пакет містить ядро. Його записують у резервний слот, і пристрій перезавантажується для пробного запуску; якщо він не підніметься, пристрій сам повернеться до поточного ядра.',
