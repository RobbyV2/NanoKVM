  ...
  translation: {
    ...
    settings: {
      ...
      passthrough: {
        ...
        isoWarning: 'ウェブカメラ、マイクなどのアイソクロナス転送デバイスはパススルーできません',
        isoWarningDesc:
          'このハードウェアはコントロール転送、バルク転送、インタラプト転送のみを扱えます。オーディオ機器や映像機器はどのようにバインドしても動作しません。',
        session: 'セッション',
        ...
        startedAt: '開始時刻',
        isoDevice:
          'このデバイスはオーディオまたはビデオクラスを名乗っており、アイソクロナス転送が必要なため動作しません。',
        ...
        startIso:
          'ウェブカメラ、マイクなどのアイソクロナス転送デバイスはこのハードウェアでは動作しません。',
        startWeb:
