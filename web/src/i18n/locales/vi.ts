  ...
  translation: {
    ...
    settings: {
      ...
      display: {
        title: 'Màn hình',
        loading: 'Đang tải...',
        active: 'EDID hiện hành',
        activeUnknown:
          'NanoKVM chưa ghi EDID nào kể từ khi khởi động, nên không rõ máy chủ đang thấy màn hình nào.',
        appliedAt: 'Đã áp dụng lúc {{time}}',
        download: 'Tải xuống',
        downloadBackup: 'Tải bản trước',
        preset: 'Cấu hình màn hình',
        presetPlaceholder: 'Chọn màn hình',
        upload: 'Tải lên',
        selected: 'EDID đã chọn',
        errors: 'Lỗi',
        warnings: 'Cảnh báo',
        info: 'Thông tin',
        unknownMonitor: 'Màn hình không xác định',
        edidVersion: 'EDID {{version}}',
        audioYes: 'Có âm thanh',
        audioNo: 'Không có âm thanh',
        extensionBlocks: 'Khối mở rộng: {{blocks}}',
        apply: 'Áp dụng',
        applyTitle: 'Áp dụng EDID này?',
        before: 'Hiện tại',
        after: 'Mới',
        ...
        unsupported: 'Thiết bị này không hỗ trợ thay đổi EDID.',
        toolMissing: 'Firmware này thiếu công cụ EDID.',
        noAudio: 'EDID này không khai báo âm thanh, nên máy chủ có thể ngừng gửi tiếng.',
        oldVersion: 'EDID này dùng phiên bản cũ hơn 1.4.',
