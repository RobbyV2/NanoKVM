  ...
  translation: {
    ...
    devices: {
      ...
      usb: {
        ...
        unsupported: 'WebUSB braucht einen Chromium-Browser über HTTPS',
    ...
    settings: {
      ...
      device: {
        ...
        media: {
          ...
          desc: 'Legen Sie fest, welche Mediengeräte Browser belegen dürfen. Das Endpunkt-Budget wird beim Anwenden des USB-Profils geprüft.',
          cameras: 'Kameras',
