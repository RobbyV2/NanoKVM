  ...
  translation: {
    ...
    settings: {
      ...
      device: {
        ...
        rebindNotice:
          'Переключение любого из тумблеров заново перечисляет USB-устройство, поэтому целевой хост ненадолго теряет виртуальные устройства и USB-сеть.',
        media: {
          ...
          budgetHint:
            'Шесть конечных точек USB IN — жёсткий предел оборудования. Соберите клавиатуру, мышь и абсолютный указатель на одном HID-интерфейсе в разделе «Представление USB» или отключите выше виртуальный диск либо USB-сеть.',
          unsupported:
