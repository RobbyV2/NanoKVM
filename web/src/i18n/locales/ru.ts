      ...
      exit: {
        ...
        commands: {
          ...
          warnWstunnelDefender:
            'Windows Defender может поместить загруженный бинарный файл wstunnel в карантин и остановить туннель, ничего не записав в свой журнал; команды родного режима ничего не загружают.',
