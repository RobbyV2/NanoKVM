const ru = {
  translation: {
    ...
    devices: {
      ...
      empty:
        'Слоты камеры или микрофона не настроены. Добавьте их в разделе «Настройки — Устройство».',
      available: 'Доступно',
    ...
    settings: {
      ...
      device: {
        ...
        media: {
          title: 'Слоты камеры и микрофона',
          desc: 'Укажите мультимедийные устройства, которые могут занять браузеры. Бюджет конечных точек проверяется при применении профиля USB. Сохранение заново перечисляет устройство и отключает подключённые браузеры.',
          cameras: 'Камеры',
          ...
          limit: 'Слотов камеры и микрофона суммарно должно быть не более восьми.',
