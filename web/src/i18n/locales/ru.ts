    ...
    settings: {
      ...
      exit: {
        ...
        commands: {
          ...
          latestDesc:
            'При запуске команды определяет новейший выпуск wstunnel на GitHub и сверяет загрузку с checksums.txt этого выпуска, так что это не закреплённая версия {{version}} и закреплённого хеша в ней нет.',
