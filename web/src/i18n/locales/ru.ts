  ...
  translation: {
    ...
    settings: {
      ...
      device: {
        ...
        networkProtocolDesc: 'NCM для современных хостов, RNDIS для старых Windows',
        reboot: 'Перезагрузка',
      ...
      network: {
        ...
        bridge: {
          title: 'Сетевой мост',
          twoDevices:
            'Маршрутизатор видит NanoKVM и управляемый компьютер как два отдельных устройства, каждое со своим адресом.',
          loading: 'Загрузка...',
          state: 'Состояние',
          states: {
            disabled: 'Отключён',
          ...
          uplink: 'Аплинк',
          ports: 'Порты',
          protocol: 'Протокол устройства',
          up: 'активен',
          down: 'неактивен',
          enableTitle: 'Включить сетевой мост?',
          disableTitle: 'Отключить сетевой мост?',
          reconnect:
