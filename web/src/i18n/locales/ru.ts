const ru = {
  translation: {
    ...
    devices: {
      ...
      empty: 'Слоты камеры или микрофона не настроены. Добавьте их в разделе «Настройки — Устройство».',
      available: 'Доступно',
      ...
      usb: {
        ...
        insecure: 'Страница открыта не по HTTPS, поэтому браузер скрывает WebUSB. Включите HTTPS в разделе «Настройки — Сеть».',
    ...
    settings: {
      ...
      passthrough: {
        ...
        copyInsecure: 'Страница открыта не по HTTPS, поэтому браузер запретил копирование. Скопируйте команду вручную или включите HTTPS в разделе «Настройки — Сеть».',
        directNote:
      ...
      mcp: {
        ...
        copyInsecure: 'Страница открыта не по HTTPS, поэтому браузер запретил копирование. Скопируйте вручную или включите HTTPS в разделе «Настройки — Сеть».',
        okBtn: 'Подтвердить',
        cancelBtn: 'Отмена'
      },
      about: {
      ...
      device: {
        ...
        rebindNotice: 'Переключение любого из тумблеров заново перечисляет USB-устройство, поэтому целевой хост ненадолго теряет виртуальные устройства и USB-сеть.',
        media: {
          ...
          budgetHint: 'Шесть конечных точек USB IN — жёсткий предел оборудования. Соберите клавиатуру, мышь и абсолютный указатель на одном HID-интерфейсе в разделе «Представление USB» или отключите выше виртуальный диск либо USB-сеть.',
          unsupported:
      ...
      update: {
        ...
        offline: {
          kernelNotice: 'В пакете содержится ядро. Оно записывается в резервный слот, и устройство перезагружается для пробного запуска; если оно не поднимется, устройство само вернётся к текущему ядру.',
