  ...
  translation: {
    ...
    settings: {
      ...
      passthrough: {
        ...
        isoWarning: 'Веб-камеры, микрофоны и другие изохронные устройства пробросить нельзя',
        isoWarningDesc:
          'Это оборудование поддерживает только управляющие, объёмные и прерывающие передачи. Аудио- и видеоустройства не заработают, как их ни привязывай.',
        session: 'Сеанс',
        ...
        startedAt: 'Запущен',
        isoDevice:
          'Это устройство сообщает класс аудио или видео, которому нужны изохронные передачи. Оно работать не будет.',
        ...
        startIso:
          'Веб-камеры, микрофоны и другие изохронные устройства на этом оборудовании работать не будут.',
        startWeb:
