const th = {
  translation: {
    ...
    devices: {
      ...
      empty: 'ยังไม่ได้ตั้งค่าช่องกล้อง ไมโครโฟน หรือลำโพง เพิ่มได้ที่ ตั้งค่า - อุปกรณ์',
      available: 'ว่าง',
      waiting: 'โฮสต์กำลังรอแหล่งสัญญาณ',
      hostOpen: 'โฮสต์เปิดอยู่',
      hostIdle: 'โฮสต์ว่างอยู่',
      hostPlaying: 'โฮสต์กำลังเล่นเสียง',
      hostSending: 'โฮสต์กำลังเล่น',
      sending: 'กำลังส่งจากเบราว์เซอร์นี้',
      receiving: 'กำลังเล่นในเบราว์เซอร์นี้',
      black: 'วิดีโอสีดำ',
      ...
      permission: {
        ...
        insecure:
          'หน้านี้ไม่ได้ให้บริการผ่าน HTTPS เบราว์เซอร์จึงปิดกั้นอุปกรณ์นี้ เปิด HTTPS ได้ที่ ตั้งค่า - เครือข่าย'
      },
      capture: {
        unsupported: 'เบราว์เซอร์นี้บันทึกเสียงหรือวิดีโอไม่ได้',
        camera: 'เบราว์เซอร์นี้เข้ารหัสภาพจากกล้องไม่ได้',
        microphone: 'เบราว์เซอร์นี้ประมวลผลเสียงจากไมโครโฟนไม่ได้',
        speaker: 'เบราว์เซอร์นี้เล่นเสียงไม่ได้'
      },
      mic: {
        mute: 'ปิดเสียง',
        unmute: 'เปิดเสียง'
    ...
    settings: {
      ...
      device: {
        ...
        rebindNotice:
          'การสลับสวิตช์นี้จะทำให้อุปกรณ์ USB ถูกแจงนับใหม่ เครื่องเป้าหมายจึงสูญเสียอุปกรณ์เสมือนและเครือข่าย USB ชั่วครู่',
        media: {
          title: 'ช่องกล้อง ไมโครโฟน และลำโพง',
          desc: 'ระบุอุปกรณ์สื่อที่เครื่องปลายทางมองเห็น งบประมาณเอนด์พอยต์จะถูกตรวจสอบเมื่อใช้โปรไฟล์ USB การบันทึกจะทำให้อุปกรณ์ถูกตรวจนับใหม่และตัดการเชื่อมต่อเบราว์เซอร์ที่เชื่อมต่ออยู่',
          cameras: 'กล้อง',
          ...
          limit: 'ช่องกล้อง ไมโครโฟน และลำโพงรวมกันต้องไม่เกินแปดช่อง',
      ...
      network: {
        ...
        usb: {
          title: 'อะแดปเตอร์เครือข่าย USB',
          desc: 'ให้การ์ดเครือข่ายผ่าน USB แก่คอมพิวเตอร์ที่ควบคุม',
          type: 'ชนิดอะแดปเตอร์',
          typeDesc: 'NCM สำหรับระบบรุ่นใหม่ RNDIS สำหรับ Windows รุ่นเก่า'
        },
        bridge: {
          title: 'อะแดปเตอร์เชื่อมต่อไปยัง',
          lan: 'เครือข่ายของคุณ',
          kvmOnly: 'เฉพาะ NanoKVM',
          lanDesc:
            'คอมพิวเตอร์จะเข้าสู่เครือข่ายของคุณผ่านพอร์ตอีเทอร์เน็ตของ NanoKVM และได้รับที่อยู่ของตัวเองจากเราเตอร์',
          kvmOnlyDesc:
            'คอมพิวเตอร์ได้รับที่อยู่จาก NanoKVM และเข้าถึง NanoKVM ได้ แต่ไปไกลกว่านั้นไม่ได้',
          loading: 'กำลังโหลด...',
          state: 'สถานะ',
          states: {
            disabled: 'เฉพาะ NanoKVM',
            enabled: 'เครือข่ายของคุณ',
          ...
          down: 'ไม่เชื่อมต่อ',
          noLink: 'ไม่มีลิงก์',
          enableTitle: 'เชื่อมต่อคอมพิวเตอร์เข้ากับเครือข่ายของคุณหรือไม่?',
          disableTitle: 'จำกัดคอมพิวเตอร์ให้ถึงเฉพาะ NanoKVM หรือไม่?',
          ...
          enableBtn: 'เข้าร่วมเครือข่ายของฉัน',
          disableBtn: 'เฉพาะ NanoKVM',
          cancelBtn: 'ยกเลิก',
          interrupted:
      ...
      exit: {
        title: 'อุโมงค์ทางออก',
        description:
          'เปลี่ยนอินเทอร์เฟซเครือข่าย USB ให้เป็นช่องทางอินเทอร์เน็ตของเครื่องเป้าหมาย: ทราฟฟิกของเครื่องเป้าหมายจะออกผ่านอุปกรณ์ของคุณที่เชื่อมต่อเข้ามาทางที่อยู่เว็บนี้',
        loading: 'กำลังโหลด...',
        noSlots: 'อุปกรณ์นี้ยังไม่ได้ตั้งค่าสล็อตทางออก',
        slot: 'สล็อต {{slot}}',
        enable: 'อุโมงค์ทางออก',
        pending: 'กำลังนำไปใช้...',
        statusStale: 'สถานะไม่อัปเดต',
        enableConfirm: 'เปิดใช้อุโมงค์ทางออกหรือไม่',
        disableConfirm: 'ปิดอุโมงค์ทางออกหรือไม่',
        reenumerate:
          'อุปกรณ์ USB จะลงทะเบียนใหม่เพื่อให้เครื่องเป้าหมายได้รับเกตเวย์และ DNS ใหม่ คีย์บอร์ด เมาส์ กล้อง และดิสก์เสมือนจะหลุดประมาณสองวินาที',
        okBtn: 'ใช่',
        cancelBtn: 'ไม่ใช่',
        copy: 'คัดลอก',
        copied: 'คัดลอกแล้ว',
        copyFailed: 'คัดลอกไม่สำเร็จ โปรดเลือกข้อความแล้วคัดลอกด้วยตนเอง',
        state: {
        ...
        status: {
          title: 'สถานะ',
          disconnect: 'ตัดการเชื่อมต่อทางออก',
          disconnectDesc:
            'ตัดการเชื่อมต่ออุปกรณ์ทางออกที่เชื่อมอยู่ ไคลเอนต์ของมันจะเชื่อมต่อกลับมาเองหากคุณไม่หยุดมันก่อน',
          tunnel: 'อุโมงค์',
          uptime: 'ทำงานมา {{uptime}}',
          lastConnected: 'เชื่อมต่อล่าสุด {{time}}',
          never: 'ไม่เคย',
          peer: 'อุปกรณ์ทางออก',
          noPeer: 'ไม่มีอุปกรณ์ทางออกเชื่อมต่ออยู่',
          peerChanged: 'เปลี่ยนจาก {{addr}} เมื่อ {{time}}',
          nic: 'การ์ดเครือข่ายของเป้าหมาย',
          nicUp: 'ทำงาน',
          nicDown: 'ไม่ทำงาน',
          nicMissing: 'ยังไม่ทราบ',
          nicNone:
            'โปรไฟล์ USB ปัจจุบันไม่มีฟังก์ชันเครือข่าย เปิดอะแดปเตอร์เครือข่าย USB ในหมวดเครือข่ายเพื่อให้เครื่องเป้าหมายมีการ์ดเครือข่าย',
          upstream: 'อินเทอร์เน็ต',
          reachable: 'เข้าถึงได้',
          unreachable: 'เข้าถึงไม่ได้',
          latency: '{{ms}} ms',
          notProbed: 'ไม่ตรวจสอบจนกว่าจะมีทางออกเชื่อมต่อ',
          downstream: 'ดาวน์สตรีม',
          downstreamOff: 'ปิดอยู่ขณะที่อุโมงค์ถูกปิดใช้',
          downstreamDegraded:
            'เส้นทางดาวน์สตรีมบางส่วนหายไป Watchdog จะลองใหม่ทุก 30 วินาที ดูบันทึกด้านล่างว่าส่วนใดล้มเหลว',
          downstreamTip: {
            forward: 'เปิดการส่งต่อ IPv4 แล้ว',
          ...
          dns: 'DNS',
          dnsStats:
            'คำขอ {{queries}} รายการ ล้มเหลว {{failures}} รายการ เปลี่ยนเส้นทาง {{redirected}} รายการ',
          traffic: 'ทราฟฟิก',
          trafficUp: '{{bytes}} ไปยังทางออก',
          trafficDown: '{{bytes}} จากทางออก'
        },
        token: {
          title: 'โทเค็น',
          history:
            'เป็นส่วนหนึ่งของทุกคำสั่งด้านล่าง จึงถูกบันทึกไว้ในประวัติเชลล์ของอุปกรณ์ทางออก',
          regenerate: 'สร้างใหม่',
          regenerateConfirm: 'สร้างโทเค็นใหม่หรือไม่',
          regenerateDesc:
            'หยุดไคลเอนต์ที่กำลังทำงานก่อน ทางออกที่เชื่อมต่ออยู่ทั้งหมดจะถูกตัด และคำสั่งเดิมจะใช้ไม่ได้อีก'
        },
        mode: {
          title: 'โหมด',
          native: 'เนทีฟ',
          wstunnel: 'wstunnel',
          nativeDesc:
            'สคริปต์ขนาดเล็กที่ดึงจาก NanoKVM นี้จะทำงานบนอุปกรณ์ทางออก ไม่ต้องติดตั้งอะไร',
          wstunnelDesc:
            'อุปกรณ์ทางออกจะดาวน์โหลดไบนารี {{version}} ที่ตรึงไว้ และตรวจสอบ SHA-256 ก่อนรัน',
          whileEnabled:
        ...
        commands: {
          ...
          warnDownload: 'คำสั่งนี้ดาวน์โหลดสคริปต์จาก NanoKVM นี้และรันในสิทธิ์ผู้ใช้ของคุณ',
          warnSecret:
          ...
          security:
            'เครื่องเป้าหมายเข้าถึงเว็บ UI, SSH และ VNC ของ NanoKVM นี้ผ่านที่อยู่เครือข่าย USB ได้อยู่แล้ว ฟีเจอร์นี้ไม่ได้เปลี่ยนเรื่องนั้น',
          latestTitle: 'wstunnel ล่าสุด',
          latestDesc:
            'เมื่อรันคำสั่ง จะค้นหารุ่น wstunnel ล่าสุดบน GitHub และตรวจสอบไฟล์ที่ดาวน์โหลดกับ checksums.txt ของรุ่นนั้น จึงไม่ใช่รุ่นที่ตรึงไว้ {{version}} และไม่มีแฮชที่ตรึงไว้ รองรับเฉพาะ Windows และ Linux',
          latestFallback: 'หากดึงข้อมูลไม่สำเร็จ ให้ดาวน์โหลดจาก github.com/erebe/wstunnel',
          latestUnavailable:
            'ไม่มีคำสั่งดึงรุ่นล่าสุดสำหรับ macOS ให้ใช้คำสั่งที่ตรึงไว้ด้านบนหรือลิงก์ที่เก็บโค้ด'
        },
        advanced: {
          title: 'ขั้นสูง',
          dns: 'เซิร์ฟเวอร์ DNS',
          dnsTip:
            'ตัวแก้ชื่อสูงสุดสี่ตัว เข้าถึงผ่านทางออก เครื่องเป้าหมายจะได้รับ NanoKVM เป็นตัวแก้ชื่อ และคำขอ DNS แบบไม่เข้ารหัสทั้งหมดจะถูกเปลี่ยนเส้นทางมาที่นี่',
          dnsAdd: 'เพิ่มเซิร์ฟเวอร์',
          dnsRemove: 'ลบเซิร์ฟเวอร์',
          dnsInvalid: 'กรอกเฉพาะที่อยู่ IP',
          dnsDenied:
            'ที่อยู่ loopback, link-local, multicast และ 198.18/15 ไม่สามารถเข้าถึงผ่านทางออกได้',
          dnsPrivate: 'ตัวแก้ชื่อส่วนตัวต้องเปิดใช้ อนุญาตปลายทางส่วนตัว',
          mtu: 'MTU',
          mtuTip: '{{min}} ถึง {{max}} ค่า 1280 เว้นที่ไว้สำหรับส่วนหัวของอุโมงค์',
          allowPrivate: 'อนุญาตปลายทางส่วนตัว',
          allowPrivateTip:
            'ให้เครื่องเป้าหมายเข้าถึง LAN ของอุปกรณ์ทางออกเอง: 10/8, 172.16/12, 192.168/16, 100.64/10 และ fc00::/7 หากปิด ปลายทางเหล่านี้จะถูกปฏิเสธ',
          pinPeer: 'ตรึงกับทางออกแรก',
          pinPeerTip:
            'ปฏิเสธการเชื่อมต่อจากที่อยู่อื่นจนกว่าจะปิด มิฉะนั้นการเชื่อมต่อใหม่ที่ถูกต้องจะแทนที่การเชื่อมต่อเดิม',
          save: 'บันทึก',
          saved: 'บันทึกแล้ว'
        },
        logs: {
