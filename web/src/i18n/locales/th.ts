  ...
  translation: {
    ...
    devices: {
      ...
      usb: {
        ...
        unsupported: 'WebUSB ต้องใช้เบราว์เซอร์ตระกูล Chromium ผ่าน HTTPS',
    ...
    settings: {
      ...
      passthrough: {
        ...
        isoWarning: 'เว็บแคม ไมโครโฟน และอุปกรณ์ไอโซโครนัสอื่น ๆ ส่งผ่านไม่ได้',
        isoWarningDesc:
          'ฮาร์ดแวร์นี้รองรับเฉพาะการถ่ายโอนแบบควบคุม แบบบัลก์ และแบบอินเทอร์รัปต์เท่านั้น อุปกรณ์เสียงและวิดีโอจะไม่ทำงานไม่ว่าจะผูกอย่างไร',
        session: 'เซสชัน',
        ...
        isoDevice:
          'อุปกรณ์นี้ประกาศเป็นคลาสเสียงหรือวิดีโอ ซึ่งต้องใช้การถ่ายโอนแบบไอโซโครนัส จึงจะไม่ทำงาน',
        ...
        startIso: 'เว็บแคม ไมโครโฟน และอุปกรณ์ไอโซโครนัสอื่น ๆ จะไม่ทำงานบนฮาร์ดแวร์นี้',
