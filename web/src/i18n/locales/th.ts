  ...
  translation: {
    ...
    devices: {
      ...
      usb: {
        ...
        insecure: 'หน้านี้ไม่ได้ให้บริการผ่าน HTTPS เบราว์เซอร์จึงปิดกั้น WebUSB เปิด HTTPS ได้ที่ ตั้งค่า - เครือข่าย',
    ...
    settings: {
      ...
      passthrough: {
        ...
        copyInsecure: 'หน้านี้ไม่ได้ให้บริการผ่าน HTTPS เบราว์เซอร์จึงปิดกั้นการคัดลอก โปรดคัดลอกคำสั่งด้วยตนเอง หรือเปิด HTTPS ที่ ตั้งค่า - เครือข่าย',
        directNote:
      ...
      mcp: {
        ...
        copyInsecure: 'หน้านี้ไม่ได้ให้บริการผ่าน HTTPS เบราว์เซอร์จึงปิดกั้นการคัดลอก โปรดคัดลอกด้วยตนเอง หรือเปิด HTTPS ที่ ตั้งค่า - เครือข่าย',
        okBtn: 'ยืนยัน',
        cancelBtn: 'ยกเลิก'
      },
      about: {
      ...
      device: {
        ...
        rebindNotice: 'การสลับสวิตช์ใดก็ตามจะทำให้อุปกรณ์ USB ถูกแจงนับใหม่ เครื่องเป้าหมายจึงสูญเสียอุปกรณ์เสมือนและเครือข่าย USB ชั่วครู่',
        media: {
          ...
          budgetHint: 'จุดปลาย USB IN หกจุดเป็นขีดจำกัดตายตัวของฮาร์ดแวร์ ให้รวมคีย์บอร์ด เมาส์ และตัวชี้แบบสัมบูรณ์ไว้บนอินเทอร์เฟซ HID เดียวในหัวข้อการนำเสนอ USB หรือปิดดิสก์เสมือนหรือเครือข่าย USB ด้านบน',
      ...
      update: {
        ...
        offline: {
          kernelNotice: 'แพ็กเกจนี้มีเคอร์เนล ระบบจะเขียนลงช่องสำรองแล้วรีบูตเพื่อทดลองใช้ หากไม่กลับมา อุปกรณ์จะย้อนกลับไปใช้เคอร์เนลปัจจุบันเอง',
