    ...
    settings: {
      ...
      exit: {
        ...
        commands: {
          ...
          latestDesc:
            'เมื่อรันคำสั่ง จะค้นหารุ่น wstunnel ล่าสุดบน GitHub และตรวจสอบไฟล์ที่ดาวน์โหลดกับ checksums.txt ของรุ่นนั้น จึงไม่ใช่รุ่นที่ตรึงไว้ {{version}} และไม่มีแฮชที่ตรึงไว้',
