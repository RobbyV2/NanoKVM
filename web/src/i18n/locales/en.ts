  ...
  translation: {
    ...
    settings: {
      ...
      assistant: {
        ...
        prompts: 'Prompts',
        promptsDesc:
          'Each entry is a table; an ask sends universal.prompt, a blank line, then the prompt of its kind (mcq, frq, custom).',
        promptsDefault: 'Default',
        promptsCustomized: 'Customized',
        promptsEntryName: 'Entry name',
        promptsFieldKey: 'Key',
        promptsAddEntry: 'Add entry',
        promptsRemoveEntry: 'Remove entry',
        promptsAddField: 'Add field',
        promptsRemoveField: 'Remove field',
        promptsSave: 'Save prompts',
        promptsReset: 'Reset to default',
        promptsResetConfirm: 'Discard the customized prompts and restore the firmware defaults?',
        promptsResetOk: 'Reset',
        promptsResetCancel: 'Cancel',
        promptsSaved: 'Prompts saved',
        promptsResetDone: 'Prompts reset to default',
        promptsLoadFailed: 'Failed to load prompts',
        loadFailed: 'Failed to load assistant settings',
        retry: 'Retry',
