  ...
  translation: {
    ...
    devices: {
      ...
      permission: {
        ...
        insecure:
          'Esta página no se sirve por HTTPS, así que el navegador bloquea este dispositivo. Activa HTTPS en Ajustes, Red.'
      },
      capture: {
    ...
    settings: {
      ...
      network: {
        ...
        usb: {
          title: 'Adaptador de red USB',
          desc: 'Da al ordenador controlado una tarjeta de red por USB',
          type: 'Tipo de adaptador',
          typeDesc: 'NCM para sistemas modernos, RNDIS para Windows antiguos'
        },
        bridge: {
          title: 'El adaptador se conecta a',
          lan: 'Tu red',
          kvmOnly: 'Solo NanoKVM',
          lanDesc:
            'El ordenador entra en tu red por el puerto Ethernet del NanoKVM, con su propia dirección del router.',
          kvmOnlyDesc:
            'El ordenador recibe su dirección del NanoKVM y llega al NanoKVM, pero a nada más.',
          loading: 'Cargando...',
          state: 'Estado',
          states: {
          ...
          down: 'inactivo',
          noLink: 'sin enlace',
          enableTitle: '¿Conectar el ordenador a tu red?',
          disableTitle: '¿Limitar el ordenador solo al NanoKVM?',
          reconnect:
      ...
      exit: {
        ...
        mode: {
          ...
          wstunnel: 'wstunnel',
          nativeDesc:
            'Recomendado. Un pequeño script descargado de este NanoKVM se ejecuta en el dispositivo de salida solo con lo que trae el sistema operativo (PowerShell, Python o Perl), como usuario normal, sin instalar nada y sin permisos de administrador.',
          wstunnelDesc:
            'Alternativa. El dispositivo de salida descarga el binario {{version}} fijado y verifica su SHA-256 antes de ejecutarlo.',
          whileEnabled:
            'Cambiar de modo con el túnel activado desconecta el dispositivo de salida conectado; reinícielo con el comando del nuevo modo.'
        },
        commands: {
          ...
          latestTitle: 'wstunnel más reciente',
          latestDesc:
            'Resuelve la versión más reciente de wstunnel en GitHub al ejecutar el comando y comprueba la descarga con el checksums.txt de esa versión, así que no es la {{version}} fijada y no lleva ningún hash fijado.',
          latestFallback: 'Si la descarga falla, descárgalo de github.com/erebe/wstunnel'
        },
        advanced: {
          title: 'Avanzado',
          dns: 'Servidores DNS',
