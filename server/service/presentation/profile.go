...
func (f *Function) validate() error {
	...
	case FunctionUAC2:
		if f.Audio == nil || f.HID != nil || f.Net != nil || f.Storage != nil || f.Video != nil {
